        ...
        with tf.Session() as sess:
            ...
            for epoch in range(max_epochs):
                ...
                if epoch % 500 == 0:
                    ...
                    with open("./loss_graph_fr/"+str(hl)+"_"+str(lr)+".txt", "a+") as fp:
                        fp.write(str(epoch) + "," + str(batch_loss))
                        fp.write("\n")
                if batch_loss < best_val_loss:
                    best_val_loss = batch_loss
                    saver.save(sess, './fr_weights/simple.weights')
            with open("test_results/fr_results.txt", "a") as fp:
