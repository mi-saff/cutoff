...
english_dev_parameters = ["result_en_dev.file", "docs_en_dev/", "labels_en_dev.txt", ".txt"]
swahili_parameters = ["result_sw.file", "docs_sw/", "labels_sw.txt", ".txt"]

#inputs, labels = get_data(*french_parameters)
inputs, labels = get_data(*english_dev_parameters)
...
def predict():
    with tf.Session() as sess:
        saver.restore(sess, "./en_weights/complex.weights")
